...
public class EventListDialog extends MessagePrompt
{
	...
	public EventListDialog(int page)
	{
		this.page = page;
	}
	...
	{
		List<Event> events = GeneralUtilities.getOrderedValues(DragonsLairMain.getSettings().getEvents());
		...
		return "---------------- Page " + (this.page + 1) + "/" + ((int)(events.size() / 12) + 1);
	}
