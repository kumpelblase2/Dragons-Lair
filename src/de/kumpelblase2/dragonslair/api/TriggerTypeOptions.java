...
{
	BLOCK_PLACE(new String[]{ "world", "x", "y", "z" }, new String[]{ "block_id", "x2", "y2", "z2", "dungeon_id" }),
	NPC_INTERACT(new String[]{ "npc_id" }, new String[]{ "dungeon_id" }),
	MOVEMENT(new String[]{ "world", "x", "y", "z" }, new String[]{ "x2", "y2", "z2", "dungeon_id" }),
	BLOCK_BREAK(new String[]{ "world", "x", "y", "z" }, new String[]{ "block_id", "x2", "y2", "z2", "dungeon_id" }),
	NPC_TOUCH(new String[]{ "npc_id" }, new String[]{ "dungeon_id" }),
	DIALOG_OCCUR(new String[]{ "npc_id", "dialog_id" }, new String[0]),
	BLOCK_INTERACT(new String[]{ "world", "x", "y", "z" }, new String[]{ "block_id", "x2", "y2", "z2", "dungeon_id" }),
	CHAPTER_CHANGE(new String[]{ "chapter_id" }, new String[]{ "dungeon_id" }),
	OBJECTIVE_CHANGE(new String[]{ "objective_id" }, new String[]{ "dungeon_id" }),
	NPC_DAMAGE(new String[]{ "npc_id" }, new String[]{ "dungeon_id" }),
