...
public class DLMap
{
	...
	public final int maxLinesPerMap = 120 / lineHeight;
	...
	{
		if(this.line > getSplittedText(this.getTitle() +"////" + this.getText()).length - 1)
			return;
	...
	public String[] getSplittedText(String in)
	{
		List<String> mapLines = new ArrayList<String>();
		String[] lines = in.split("//");
		MinecraftFont f = MinecraftFont.Font;
